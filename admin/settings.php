...
if (isset($_POST['save'])) {
    ...
    $edit_sql = mysqli_query($connect, "UPDATE settings SET sitename='$sitename', description='$description', email='$email', gcaptcha_sitekey='$gcaptcha_sitekey', gcaptcha_secretkey='$gcaptcha_secretkey', facebook='$facebook', instagram='$instagram', twitter='$twitter', youtube='$youtube', rtl='$rtl', comments='$comments', date_format='$date_format', background_image='$image', theme='$theme'");
}
?>
...
<?php
$themes = array("Bootstrap 5", "Cerulean", "Cosmo", "Cyborg", "Darkly", "Flatly", "Journal", "Litera", "Lumen", "Lux", "Materia", "Minty", "Morph", "Pulse", "Quartz", "Sandstone", "Simplex", "Sketchy", "Slate", "Solar", "Spacelab", "Superhero", "United", "Vapor", "Yeti", "Zephyr");
