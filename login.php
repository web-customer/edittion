                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <form action="" method="post">
                                    ...
                                    <button type="submit" name="register" class="btn btn-primary col-12"><i
                            ...
                            <div class="col-md-6">
                                <h5><i class="fas fa-sign-in-alt"></i> Sign In</h5>
                                <hr/>
                                <?php
		...
		<div class="alert alert-danger">
            <i class="fas fa-exclamation-circle"></i> The entered <strong>Username</strong> or <strong>Password</strong> is incorrect.
                                ...
                                <form action="" method="post">
                                    ...
                                    <button type="submit" name="signin" class="btn btn-primary col-12"><i
                                                class="fas fa-sign-in-alt"></i>
                                        &nbsp;Sign In
                                    </button>
